...
func newTestProvider(c *mockHttpClient) PushProvider {
	return NewPushProvider(c, config.PushProviderConfig{
...
func TestPushProvider_Deliver_Success(t *testing.T) {
...
func TestPushProvider_Deliver_HttpClientError_ReturnsError(t *testing.T) {
	mockClient := &mockHttpClient{}
...
func TestPushProvider_Deliver_BadStatusCode_ReturnsError(t *testing.T) {
	mockClient := &mockHttpClient{}
	resp := &http.Response{
...
func TestPushProvider_Deliver_UnmarshalError_ReturnsError(t *testing.T) {
	mockClient := &mockHttpClient{}
	resp := &http.Response{
		StatusCode: http.StatusAccepted,

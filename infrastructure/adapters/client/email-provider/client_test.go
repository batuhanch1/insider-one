...
func newTestProvider(c *mockHttpClient) EmailProvider {
	return NewEmailProvider(c, config.EmailProviderConfig{
...
func TestEmailProvider_Deliver_Success(t *testing.T) {
	...
	result, err := provider.Deliver(context.Background(), &DeliverRequest{
		To: "test@example.com", From: "from@example.com",
	})
...
func TestEmailProvider_Deliver_HttpClientError_ReturnsError(t *testing.T) {
	mockClient := &mockHttpClient{}
...
func TestEmailProvider_Deliver_BadStatusCode_ReturnsError(t *testing.T) {
	mockClient := &mockHttpClient{}
	resp := &http.Response{
...
func TestEmailProvider_Deliver_UnmarshalError_ReturnsError(t *testing.T) {
	mockClient := &mockHttpClient{}
	resp := &http.Response{
		StatusCode: http.StatusAccepted,
